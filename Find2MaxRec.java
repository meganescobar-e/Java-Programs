...
public class Find2MaxRec {
	...
	public static void main(String[] args) {
		...
		getStudents(input, numStudents,nameStudents,0);
	...
	public static void getStudents (Scanner input, double [] numberStudents, String [] nameStu, int number) {						
		if (number < numberStudents.length) {	
			...
			getStudents(input, numberStudents, nameStu, number+1);
		}
