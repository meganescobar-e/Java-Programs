...
*/
    /**
     * @param list to make new array list
     */
...
*/
            /**
             * @param do executes code if input is not 0
             */
            do {
		inputLine = input.nextLine();
/*
*  In the first if-statement, the inputLine must have a length
...
*/
                /**
                 * @param length to identify an empty String
                 */
...
*/
                /**
                 * @param matches to ensure input is not a letter
                 */
		    ...
		    System.exit(0);
                ...
                /**
                 *  @param count limits the array to 10 integers.
                 */   		
		else if (count >= 10) {
